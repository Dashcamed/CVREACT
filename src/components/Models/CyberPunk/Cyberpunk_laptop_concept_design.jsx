...
Command: npx gltfjsx@6.5.3 cyberpunk_laptop_concept_design.glb -T 
Files: cyberpunk_laptop_concept_design.glb [10.78MB] > C:\Users\camil\Documents\CODER HOUSE\CVREACT\public\models\cyberpunk_laptop_concept_design-transformed.glb [910.05KB] (92%)
...
export function CyberPunk(props) {
  const { nodes, materials } = useGLTF(
    "/models/cyberpunk_laptop_concept_design-transformed.glb"
  );
  return (
...
useGLTF.preload("/models/cyberpunk_laptop_concept_design-transformed.glb");
